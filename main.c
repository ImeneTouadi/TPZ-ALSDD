  ...
  void Arbreexemple (Pointeur_ATib *T)
    {
     ...
     S = malloc(sizeof(Type_Tib));
     Creernoeud_ATib (& *T ) ;
     Aff_struct1_Tib ( S  , 45 ) ;
     Aff_struct2_Tib ( S  , False ) ;
     Aff_info_ATib ( *T , S ) ;
     Aff_pere_ATib ( *T , NULL ) ;
     Creernoeud_ATib (& R ) ;
     Aff_struct1_Tib ( S  , 20 ) ;
     Aff_struct2_Tib ( S  , False ) ;
     Aff_info_ATib ( R , S ) ;
     Aff_fg_ATib ( *T , R ) ;
     Aff_pere_ATib ( R , *T ) ;
     Creernoeud_ATib (& R2 ) ;
     Aff_struct1_Tib ( S  , 10 ) ;
     Aff_struct2_Tib ( S  , False ) ;
     Aff_info_ATib ( R2 , S ) ;
     Aff_fg_ATib ( R , R2 ) ;
     Aff_pere_ATib ( R2 , R ) ;
  ...
  void Generatetree (Pointeur_ATib *Tree)
    {
     ...
     printf ( " %s", " " ) ;
     printf ( " %s", " \nDo you want to : \n" ) ;
     printf ( " %s", " 1. Generate a defined tree ( the tree exemple in the tp ) \n" ) ;
     printf ( " %s", " 2. Generate a random tree \n" ) ;
     printf ( "\n" ) ;
     printf ( "Enter you choice : " ) ;

     Choicecreatetree  =  0 ;
     while( ( Choicecreatetree > 2 ) || ( Choicecreatetree < 1 )) {
       scanf ( " %d", &Choicecreatetree ) ;
  ...
  int main(int argc, char *argv[])
    {
     ...
     for( M  =  1 ;M <=  Numberiterations ; ++M){
       ...
       while( Iterationterminee == False) {
         ...
         printf ( " %s", " ========== MENU ========== " ) ;
         printf ( "\n" ) ;
         printf ( " %s", " 1. Generate a binary search tree " ) ;
         printf ( "\n" ) ;
         printf ( " %s", " 2. Verify that the tree is correctly constructed " ) ;
         printf ( "\n" ) ;
         printf ( " %s", " 3. Apply the traversals " ) ;
         printf ( "\n" ) ;
         printf ( "\n" ) ;
